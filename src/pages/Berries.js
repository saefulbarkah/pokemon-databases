...
function Berries() {
  ...
  return (
    <>
      <Title name="Pokemon Database | Berry" />
      <section>
        ...
        <div className="mt-5">
          ...
          <div className="my-2">
            <Paragraph>
              ...
              newly introduced held items feature. Pokémon do not know how to
              use held artificial healing items, such as Potions and Full Heals,
              but they can use held Berries.
            </Paragraph>
          </div>
        </div>
